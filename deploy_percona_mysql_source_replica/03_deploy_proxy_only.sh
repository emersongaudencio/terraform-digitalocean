...
echo "resource \"digitalocean_droplet\" \"proxysql01\" {
    ...
    region = \"lon1\"
    size = \"s-3vcpu-1gb\"
    user_data = \"#!/bin/bash\ncurl -sS https://raw.githubusercontent.com/emersongaudencio/general-deployment-scripts/master/automation/install_ansible_proxysql2_replica.sh | sudo bash\"
